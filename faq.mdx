...
<AccordionGroup>
  ...
  <Accordion title="How do I get help?">
    When Synclify hits an error it offers a pre-filled support report — accept it. Or email [hello@synclify.cloud](mailto:hello@synclify.cloud). See [Troubleshooting](/troubleshooting) first for the common ones.
  </Accordion>
</AccordionGroup>