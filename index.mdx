...
<Frame caption="Every source table you sync into Webflow, its direction, schedule, and live status — in one list.">
  <img src="/images/connections-list.png" alt="The Synclify Connections page listing two connections with their direction, destination site, status, and schedule" />
</Frame>
