...
<Frame caption="Every source table you sync into Webflow, its direction, schedule, and live status — in one list.">
  <img src="/images/connections-list.png" alt="The Synclify Connections page listing three connections with their direction, destination site, status, and schedule" />
</Frame>
...
<Steps>
  <Step title="Data sources">
    The accounts you connect. Webflow is always the destination. Airtable is the source.
    See [Connect Webflow](/data-sources/connect-webflow) and [Connect Airtable](/data-sources/connect-airtable).
  </Step>
