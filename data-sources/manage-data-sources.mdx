...
<Steps>
  <Step title="Delete or archive dependent connections">
    Every connection using the account must be archived or deleted first. See [Archive and delete](/connections/archive-and-delete).
  </Step>
