...
<Frame caption="Onboarding is a single step: connect Webflow before anything else.">
  <img src="/images/onboarding-connect-webflow.png" alt="Onboarding step one titled Connect Webflow, with a button to connect your Webflow account and import your CMS collections" />
</Frame>
...
<Frame caption="A connected Webflow account expands into its sites, and each site into its CMS collections.">
  <img src="/images/webflow-resources.png" alt="Data Sources page showing a Webflow account expanded into Acme Webflow Site and its Products, Blog Posts, and Case Studies collections, each with a field count" />
</Frame>
